...
public class Empresa {
    ...
    public ArrayList<Sala> getSalas() {
     ...
     /**
      * Añadir un nuevo cliente. Antes de dar de alta un nuevo cliente, comprobará si 
      * el cliente ya existe
      * @param cif
      * @param nombre
      * @param direccion
      * @param poblacion
      * @return  devuelve un dato de tipo boolean. falso en el caso
      * de que si le haya dado de alta y true en caso contrario
      */
